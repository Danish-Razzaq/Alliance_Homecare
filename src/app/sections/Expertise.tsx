...
const Expertise = () => {
  return (
    ...
    <div className='flex flex-col gap-6 items-start w-full'>
        <h1 className='text-5xl font-bold text-blue-900 max-sm:text-xl w-full'>HOME CARE IS EASIER THAN EVER!</h1>
    ...
    <div className='w-full   md:mb-4 '>
        <Image src={care} alt='care.IMg' className='rounded-full max-lg:rounded-xl border border-green-500 w-[400px] h-[400px]'/>
    </div>
    </section>
  );
}
